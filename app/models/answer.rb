class Answer < ApplicationRecord
  ...
  validates :distance, inclusion: { in: VALID_DISTANCE, message: "The distance must a number between 1 and 99." }
  ...
  validates_presence_of :team, :down, :distance, :yardline_num
end
